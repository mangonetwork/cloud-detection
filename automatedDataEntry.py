...
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.4, random_state=0) #0.2 may be the norm here?? split the dataset into a test/train duo for fitting (60% of data) and evaluating fit quality (40% of data). Consistent random state is used to ensure testing is consistent 
